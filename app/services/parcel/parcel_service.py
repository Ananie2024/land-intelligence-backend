...
class ParcelService:
    ...
    async def create_parcel(self, payload: ParcelCreate, user_id: str) -> Parcel:
        ...
        await self.parish_repo.update_parcel_count(payload.parish_id)
    ...
    async def delete_parcel(self, parcel_id: str, user_id: str) -> bool:
        """
        Soft-delete a parcel and update parish parcel count.
        """
        ...
        await self.parish_repo.update_parcel_count(parish_id)
