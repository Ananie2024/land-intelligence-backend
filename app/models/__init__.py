...
def import_all_models():
    ...
    # Import dependent models first so Parcel relationship back_populates can resolve.
    from app.models.parcel_ownership_history import ParcelOwnershipHistory  # noqa: F401
