...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column('hashed_password', sa.String(255), nullable=False, comment='Argon2 hashed password'),
    ...
    op.create_table(
        ...
        sa.Column('performed_at', sa.DateTime(timezone=True), nullable=False, comment='Timestamp when action was performed'),
    ...
    op.create_table(
        ...
        sa.Column('expires_at', sa.DateTime(timezone=True), nullable=True, comment='Expiration timestamp (if temporary)'),
        sa.Column('last_accessed_at', sa.DateTime(timezone=True), nullable=True, comment='Last time this QR was scanned'),
