  ...
  return (
    <div className="min-h-screen w-screen bg-slate-950 flex flex-col items-center justify-center p-6 relative font-sans">
      ...
      <div className="text-center z-10 flex flex-col items-center gap-6 max-w-md">
        ...
        <h1 className="text-5xl font-black text-white m-0 tracking-tight leading-none bg-clip-text text-transparent bg-gradient-to-b from-white to-slate-500">
          Access Denied
        </h1>
        
        <h2 className="text-lg font-bold text-slate-300 tracking-tight leading-tight m-0">
